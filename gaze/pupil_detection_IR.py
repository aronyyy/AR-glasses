...
def process_video(video_path):
    ...
    cap = cv2.VideoCapture(video_path)  # Only file input
    ...
    while True:
        ...
        thresholded_image_strict = mask_outside_square(apply_binary_threshold(gray_frame, darkest_pixel_value, 5), darkest_point, 250)
        thresholded_image_medium = mask_outside_square(apply_binary_threshold(gray_frame, darkest_pixel_value, 15), darkest_point, 250)
        thresholded_image_relaxed = mask_outside_square(apply_binary_threshold(gray_frame, darkest_pixel_value, 25), darkest_point, 250)

        pupil_rotated_rect = process_frames(

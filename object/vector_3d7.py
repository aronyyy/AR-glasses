...
# Back to the 80-class COCO dataset
# Event-focused list of SMALL, common items
KNOWN_OBJECTS = {
...
def main():
    ...
    # Load YOLOv8 model
    # --- CHANGED: Using the "medium" (m) COCO model for more precision ---
    model = YOLO("yolov8m.pt") 
    model.to(device)
    print("Loaded YOLOv8m model (80 classes).")
